...
\begin{figure}[H]
  ...
  \includegraphics[width=0.96\textwidth]{img/超螺旋.png} % 替换为你的图片文件名
...
\begin{figure}[H]
  ...
  \includegraphics[width=0.96\textwidth]{img/压缩.png} % 替换为你的图片文件名
...
\begin{figure}[H]
  ...
  \includegraphics[width=0.96\textwidth]{img/DNA复制.png} % 替换为你的图片文件名
